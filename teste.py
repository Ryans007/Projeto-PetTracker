...
timestamp = 1740256532.8873396
data_formatada = datetime.fromtimestamp(timestamp).strftime("%d/%m/%Y %H:%M:%S.%f")[:-3]
print(data_formatada)  # Exemplo: 23/07/2025 14:15:32.887
